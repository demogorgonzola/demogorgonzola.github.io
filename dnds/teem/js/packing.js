...
function packContainer(widthPackerMethod) {
  ...
  let containerPadding = container.style.padding;

  let childStyle = children[0].style;
  let childMargin = isNaN(Number(childStyle.marginLeft)) ? 0 : Number(childStyle.marginLeft) +
                    isNaN(Number(childStyle.marginRight)) ? 0 : Number(childStyle.marginRight);
  if(childMargin == 0)
    childMargin = isNaN(Number(childStyle.margin)) ? 0 : Number(childStyle.margin);

  children[0].style.marginLeft + children[0].style.marginRight
